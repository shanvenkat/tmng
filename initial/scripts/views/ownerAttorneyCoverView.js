// SearchView.js
// -------
define(['jquery', 'jqueryui', 'backbone', 'collections/ownerCollection', 'collections/attorneyCollection','text!templates/ownerCover.html', 'text!locale/en_us/attorneyDetails.json'],
    ...
    function($, jqueryui, Backbone, OwnerCollection, AttorneyCollection, template, content) {
        ...
        var OwnerAttorneyCoverView = Backbone.View.extend({
            ...
            // View Event Handlers
            events: {
                "click #addAnotherOwner" : "gotoOwnerList",
                ...
                "click #continueButton": "gotoOwnerList",
            ...
            gotoAttorneyDetails: function(e) {
                if(this.markId!=null){
                    var navString = '#attorneyDetails/'+this.markId;
                    this.pageNavigator(navString, true);
                }else{
                    var navString = "#markCover";
                    this.pageNavigator(navString,true);
