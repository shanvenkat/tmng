// SearchView.js
// -------
define(['jquery', 'jqueryui', 'backbone',  'text!templates/confirmEntries.html'],
    ...
    function($, jqueryui, Backbone, template) {
        ...
        var ReviewAndSignCoverView = Backbone.View.extend({
            ...
            // View Event Handlers
            events: {
                'click #continueButton': "gotoReviewSummary"
            },
            ...
            gotoReviewSummary: function(e) {
                var navString = '#reviewSummary'
